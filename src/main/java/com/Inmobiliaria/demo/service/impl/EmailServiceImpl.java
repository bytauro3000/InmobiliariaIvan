...
public class EmailServiceImpl implements EmailService {
    ...
    private String construirCuerpoMultiple(List<PagoLetras> pagos) {
        ...
        return "<html><body style='font-family: Arial, sans-serif; color: #333;'>"
            ...
            + letras + " registrado el <strong>" + (primero.getFechaPago() != null ? primero.getFechaPago().toLocalDate() : "") + "</strong>.</p>"
    ...
    private String construirCuerpo(PagoLetras pago) {
        ...
        return "<html><body style='font-family: Arial, sans-serif; color: #333;'>"
            ...
            + (pago.getFechaPago() != null ? pago.getFechaPago().toLocalDate() : "") + "</strong>.</p>"
