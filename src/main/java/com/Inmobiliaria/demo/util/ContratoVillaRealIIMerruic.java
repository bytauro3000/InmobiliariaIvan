...
/**
 * Plantilla de contrato para el PROGRAMA DE VIVIENDA VILLA REAL II (Inmobiliaria Merruic).
 * Solo modalidad FINANCIADO.
 *
 ...
 */
public class ContratoVillaRealIIMerruic {
	...
	public static byte[] generarContratoVillaRealII(ContratoResponseDTO contrato, LetraCambio primeraLetraEntidad) {
		ByteArrayOutputStream out = new ByteArrayOutputStream();
		PdfWriter writer = new PdfWriter(out);
		PdfDocument pdf = new PdfDocument(writer);
		Document document = new Document(pdf);
		document.setMargins(99, 73, 57, 99);
		...
		try {
			byte[] nBytes = StreamUtil.inputStreamToArray(
					ContratoVillaRealIIMerruic.class.getClassLoader().getResourceAsStream("fonts/ARIALN.TTF"));
			arialNarrow = PdfFontFactory.createFont(nBytes, PdfEncodings.WINANSI);

			byte[] nbBytes = StreamUtil.inputStreamToArray(
					ContratoVillaRealIIMerruic.class.getClassLoader().getResourceAsStream("fonts/ARIALNB.TTF"));
		...
		document.add(new Paragraph("VILLA REAL II")
				.setFont(arialNarrowBold).setFontSize(12).setUnderline()
				.setTextAlignment(TextAlignment.CENTER)
				.setFixedLeading(12).setMarginBottom(0));

		document.add(new Paragraph("CONTRATO PRIVADO DE COMPRAVENTA DE TERRENO RÚSTICO EN FUTURA HABILITACION URBANA")
				.setFont(arialNarrowBold).setFontSize(12).setUnderline()
				.setTextAlignment(TextAlignment.CENTER)
		...
		primeraCuerpo.add(new Text("EL VENDEDOR").setFont(arialNarrowBold));
		primeraCuerpo.add(" es copropietario del 80.12% de acciones y derechos del inmueble denominado PARCELA 5-B DE LA ZONA A DEL FUNDO SANTA INÉS, EX ESTABLO MARANGA, U.C. N° 02974 (PARTE) equivalente a un área física de 5,164.00m2, situado a la altura del kilómetro 3 de la Av. José Saco Rojas, Distrito de Carabayllo, Provincia y Departamento de Lima. Cuyo predio fue adquirido mediante contrato privado de compraventa de terreno rustico de fecha 19/11/2019 celebrada con sus anteriores propietarios OLGA CONSUELO VIVAS MENENDEZ, identificada con DNI N° 06926190 y LUÍS EMILIO VIVAS MENENDEZ, identificada con DNI N° 41633683 (sucesión intestada de quienes en vida fueron EMILIO VIVAS REYNOSO y DOLORES LEONISA MENENDEZ LOPEZ VIUDA DE VIVAS), OSCAR GERARDO WILLIAMS MENENDEZ, identificado con DNI N° 09671279, ANA MARIA WILLIAMS MENENDEZ DE VILLAJUAN, identificada con DNI N° 07993343, (sucesión intestada de quien en vida fue DOLORES LEONISA MENENDEZ LOPEZ VIUDA DE VIVAS). ");
		primeraCuerpo.add(new Text("EL VENDEDOR").setFont(arialNarrowBold));
		primeraCuerpo.add(" con fecha 19/11/2019 celebró el CONTRATO PRIVADO DE COMPRAVENTA DE TERRENO RÚSTICO a fin que la empresa en mención realice la lotización del 80.12% de acciones y derechos que equivale a un área de 5,164.00m2 de terreno, la misma que encuentra dentro del área de mayor extensión a que hace referencia esta cláusula, en ese sentido, la empresa, sobre el referido terreno viene desarrollando el PROGRAMA DE VIVIENDA ");
		primeraCuerpo.add(new Text("\u201cVILLA REAL II\u201d").setFont(arialNarrowBold));
		...
		segundaIntro.add(" el lote de terreno rústico ubicado en el PROGRAMA DE VIVIENDA VILLA REAL II, Manzana ");
		...
		segundaIntro.add(", situado en el Distrito de Carabayllo, Provincia y Departamento de Lima, encerrado dentro de los siguientes linderos y medidas perimétricas:");
		...
		lugarPago.add(new Text("EL VENDEDOR").setFont(arialNarrowBold));
		...
		cuartoCuerpo.add(new Text("EL VENDEDOR").setFont(arialNarrowBold));
		cuartoCuerpo.add(" ");
	...
	private static void agregarGravamen(Document document, PdfFont arialNarrowBold, PdfFont arialNarrow, String titulo) {
		...
		cuerpo.add(new Text(titulo + " ").setFont(arialNarrowBold));
		cuerpo.add(new Text("EL VENDEDOR").setFont(arialNarrowBold));
	...
	private static void agregarHabilitacionFinanciado(Document document, PdfFont arialNarrowBold, PdfFont arialNarrow, String etiquetaComprador) {
		...
		c14.add(new Text("EL VENDEDOR").setFont(arialNarrowBold));
		...
		c15.add(new Text("EL VENDEDOR").setFont(arialNarrowBold));
	...
	private static void agregarRenuncia(Document document, PdfFont arialNarrowBold, PdfFont arialNarrow, String etiquetaComprador) {
		...
		p1.add(new Text("EL VENDEDOR").setFont(arialNarrowBold));
		...
		p2.add(new Text("EL VENDEDOR").setFont(arialNarrowBold));
		...
		p3.add(new Text("EL VENDEDOR").setFont(arialNarrowBold));
